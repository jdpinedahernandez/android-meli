...
import com.juanpineda.meli.ui.modules.home.productdetail.viewmodel.ProductDetailViewModel.UiModel.LoadFavoriteContent
...
class ProductDetailViewModelTest {
    ...
    @Before
    fun setup() {
        sut = ProductDetailViewModel(mockedProduct.id, findProductById, toggleProductFavorite)
    }
